<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="index.html">Đang gửi</a></li>
        <li class="breadcrumb-item active">Danh sách</li>
    </ol>
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-table mr-1"></i>Dánh sách đơn hàng đang gửi</div>
        <div class="card-body">
                          ...
                          <tr>
                            ...
                            <td>
                                <button type="button" id="btn-modal" class="btn btn-primary" 
                                    onclick="show(<?=$value['id']?>);" data-toggle="modal" data-target="#2exampleModalCenter">Xem
                                </button>
                            </td>
                            <td>
                                <a href="?controller=admin&action=dang-gui&param=delete&id=<?=$value['id']?>" 
                                    class="btn btn-danger">Huỷ đơn</a>
                            </td>
                            <td>
                                <a href="?controller=admin&action=dang-gui&param=update&id=<?=$value['id']?>" 
                                    class="btn btn-success">Đã nhận </a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
